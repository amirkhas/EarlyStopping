...
class Inference:
    def __init__(self, model_info: dict, dataset_info: dict, verbose: dict):
        ...
        # self.model = LLM(model=self.model_info["model_name"])
        self.model = LLM(model="Qwen/Qwen2.5-3B-Instruct")
    ...
    def greedy_inference(self):
        for i in range(123, self.data_size):
    ...
    def model_inference(self, batch_input_txt):
        ...
        generation_output = self.model.generate(batch_input_txt, sampling_params)
